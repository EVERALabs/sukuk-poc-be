    ...
    "paths": {
        ...
        "/events/redemption-requested": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "RedemptionRequested event data",
                        "name": "event",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RedemptionRequested"
                        }
                    }
                ],
                "responses": {
        ...
        "/events/redemption-requested/unprocessed": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of unprocessed events",
                        "schema": {
                            "$ref": "#/definitions/handlers.APIResponse"
                        }
                    },
        ...
        "/events/sukuk-purchased": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SukukPurchased event data",
                        "name": "event",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SukukPurchased"
                        }
                    }
                ],
                "responses": {
        ...
        "/events/sukuk-purchased/unprocessed": {
            "get": {
